    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                ajax.post(WsPath.Resource.User, data, AxiosUtil.FormRequestConfig).then((data) => {
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Item {...formItemLayout} label={intl.formatMessage(appMessage.userName)}>
                            {getFieldDecorator('name', {
                                ...
                                <Input disabled={this.state.updating} placeholder={intl.formatMessage(appMessage.userName)}/>
                            )}
                        </Form.Item>
                        <Form.Item style={{textAlign: "center"}}>
                            <Button type="primary" htmlType="button" className={"form-btn"} onClick={this.exitEdit} disabled={this.state.updating}>
                                <FormattedMessage {...appMessage.cancel}/>
                            </Button>
                            <Button type="primary" className={"form-btn"} htmlType="submit" loading={this.state.updating}>
