...
class App extends Component {
    ...
    componentWillMount() {
        ...
        ajax.get(AxiosUtil.getURL(WsPath.Resource.User, { userId: this.props.userId }))
            .then((data) => {
        ...
        if (this.state.loading) {
            return (
                <Spin
                    ...
                    tip={intl.formatMessage(messages.userLoading)}
                />
            );
        }
        return (
            <Layout className={"App"}>
                <Sider
                    ...
                    <div className="App-Logo">
                        <FormattedMessage {...(this.props.collapsed ? appMessage.shortName : appMessage.name)} />
                    </div>
                    <SiderMenu
                        theme={this.props.siderTheme}
                        collapsed={this.props.collapsed}
...
export default withRouter(
    withAuthorizeCheck(injectIntl(connect(mapStateToProps)(App)), (props) => (
