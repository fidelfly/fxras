...
class Logout extends Component {
    ...
    componentWillMount() {
        if(!this.state.logout) {
            ...
            ajax.post(AxiosUtil.getURL(WsPath.Service.logout)).then( data => {
                dispatch(logout());
                auth.logout();
    ...
    render() {
        if (this.props.userInfo) {
            ...
            if (this.state.logout) {
                ...
                return <Spin size="large" style={{width: "100%", height: "100%", paddingTop: "10%"}} tip = {intl.formatMessage(messages.logoutLoading)}/>
            }
        } else {
