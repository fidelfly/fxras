...
class ProgressDemo extends Component {
    showProgress = () => {
        ...
        dispatch(startProgress("progressDemo", undefined, { name: "Progress Demo", message: "Processing..." }))
            .then((ws) => {
                return attachCancelablePromise(
                    ajax.post("/example/progress", { progressKey: ws.key }, AxiosUtil.FormRequestConfig),
                    this
                ).promise;
            })
            .then(() => {
